        ...
        <Card className="mt-6 w-4/5 p-5">
          <div className='text-center'>
            ...
            <a href={'/course/' + module.parentSubject._id}>
              <Typography variant='paragraph' className= 'text-blue-400'>{module.parentSubject.name}</Typography>
            </a>
            <a onClick={openDrawer} href='#'>
              <Typography variant='small' className={(check()._id == module.createdBy) ? 'text-blue-300 underline' : 'hidden'} >
                Edit
              </Typography>
            </a>
            <hr></hr><br/>
            ...
            <Typography variant='h6' className='text-left text-black-200'>
              Sessions
              <Button size='sm' onClick={() => { window.location.href = '/course/' + params.subjectid +'/'+params.moduleid+ '/new' }} className={(check()._id == module.createdBy) ? 'visible m-2' : 'hidden'} >
                New Session
              </Button>
            </Typography>
            <div>
